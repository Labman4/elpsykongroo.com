...
function getIP() {
    ...
    $.ajax({
        ...
        url: "https://api.elpsykongroo.com/ip",
        async: false,
...
(function (){
    ...
    if(document.referrer == ''){
        ...
        text = '嗨！来自 <span style="color:#0099cc;">' + getIP() + '</span> 的朋友！';
