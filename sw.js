...
}, re = (t) => [C.prefix, t, C.suffix].filter((e) => e && e.length > 0).join("-"), Yt = (t) => {
...
function Qt(t) {
  ...
  return r.searchParams.set(Xt, e), {
    cacheKey: r.href,
    url: o.href
  };
}
...
function nn(t) {
  const e = t.length;
  e > 0 && (u.groupCollapsed(`During precaching cleanup, ${e} cached request${e === 1 ? " was" : "s were"} deleted.`), tn("Deleted Cache Requests", t), u.groupEnd());
}
function Ue(t, e) {
  if (e.length !== 0) {
    u.groupCollapsed(t);
...
async function sn(t, e) {
  ...
  }, s = e ? e(o) : o, a = on() ? r.body : await r.blob();
...
async function un() {
  ({}).NODE_ENV !== "production" && u.log(`About to run ${Fe.size} callbacks to clean up caches.`);
  for (const t of Fe)
...
class hn {
  ...
  constructor(e, n) {
    ...
    }), Object.assign(this, n), this.event = n.event, this._strategy = e, this._handlerDeferred = new cn(), this._extendLifetimePromises = [], this._plugins = [...e.plugins], this._pluginStateMap = /* @__PURE__ */ new Map();
  ...
  async cachePut(e, n) {
    ...
    const { cacheName: a, matchOptions: i } = this._strategy, c = await self.caches.open(a), h = this.hasCallback("cacheDidUpdate"), l = h ? await an(
    ...
    try {
      ...
      if (d instanceof Error)
        throw d.name === "QuotaExceededError" && await un(), d;
    }
...
class dn {
  ...
  handleAll(e) {
    ...
    const n = e.event, r = typeof e.request == "string" ? new Request(e.request) : e.request, o = "params" in e ? e.params : void 0, s = new hn(this, { event: n, request: r, params: o }), a = this._getResponse(s, r, n), i = this._awaitComplete(a, s, r, n);
    return [a, i];
  }
...
class fn {
  ...
  constructor({ cacheName: e, plugins: n = [], fallbackToNetwork: r = !0 } = {}) {
    this._urlsToCacheKeys = /* @__PURE__ */ new Map(), this._urlsToCacheModes = /* @__PURE__ */ new Map(), this._cacheKeysToIntegrities = /* @__PURE__ */ new Map(), this._strategy = new I({
      ...
      plugins: [
        ...n,
        new en({ precacheController: this })
      ],
      fallbackToNetwork: r
  ...
  addToCacheList(e) {
    ...
    for (const r of e) {
      ...
      const { cacheKey: o, url: s } = Qt(r), a = typeof r != "string" && r.revision ? "reload" : "default";
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  install(e) {
    return Be(e, async () => {
      ...
      return {}.NODE_ENV !== "production" && rn(r, o), { updatedURLs: r, notUpdatedURLs: o };
    });
  }
  /**
  ...
  activate(e) {
    return Be(e, async () => {
      ...
      return {}.NODE_ENV !== "production" && nn(s), { deletedURLs: s };
    });
  }
  /**
...
class F {
  ...
  constructor(e, n, r = nt) {
    ({}).NODE_ENV !== "production" && (b.isType(e, "function", {
      ...
      funcName: "constructor",
      paramName: "match"
    }), r && b.isOneOf(r, pn, { paramName: "method" })), this.handler = q(n), this.match = e, this.method = r;
  }
  /**
   *
   * @param {workbox-routing-handlerCallback} handler A callback
...
let V;
const wn = () => (V || (V = new mn(), V.addFetchListener(), V.addCacheListener()), V);
function bn(t, e, n) {
  let r;
  if (typeof t == "string") {
    const s = new URL(t, location.href);
...
function* En(t, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: n = "index.html", cleanURLs: r = !0, urlManipulation: o } = {}) {
  const s = new URL(t, location.href);
  s.hash = "", yield s.href;
  const a = yn(s, e);
...
function vn(t) {
  const e = tt(), n = new _n(e, t);
  bn(n);
}
const Cn = "-precache-", Tn = async (t, e = Cn) => {
...
const rt = function(t) {
   ...
   */
  decodeString(t, e) {
    return this.HAS_NATIVE_SUPPORT && !e ? atob(t) : Dn(this.decodeStringToByteArray(t, e));
  },
  /**
   * Base64-decode a string.
   *
 ...
 * limitations under the License.
 */
const Ln = () => $n().__FIREBASE_DEFAULTS__, Pn = () => {
...
class B extends Error {
  constructor(e, n, r) {
    super(n), this.code = e, this.customData = r, this.name = Un, Object.setPrototypeOf(this, B.prototype), Error.captureStackTrace && Error.captureStackTrace(this, X.prototype.create);
  }
}
class X {
  constructor(e, n, r) {
  ...
  create(e, ...n) {
    const r = n[0] || {}, o = `${this.service}/${e}`, s = this.errors[e], a = s ? Vn(s, r) : "Error", i = `${this.serviceName}: ${a} (${o}).`;
    return new B(o, i, r);
  }
}
function Vn(t, e) {
  return t.replace(Fn, (n, r) => {
    const o = e[r];
...
class Yn {
   ...
   */
  constructor(e) {
    this.name = e, this._logLevel = zn, this._logHandler = Jn, this._userLogHandler = null;
  }
  get logLevel() {
  ...
  setLogLevel(e) {
    this._logLevel = typeof e == "string" ? Wn[e] : e;
  }
  get logHandler() {
...
const Xn = (t, e) => e.some((n) => t instanceof n);
let He, Ke;
function Qn() {
  return He || (He = [
    IDBDatabase,
...
const lt = /* @__PURE__ */ new WeakMap(), me = /* @__PURE__ */ new WeakMap(), ht = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakMap();
function er(t) {
...
function or(t) {
  return typeof t == "function" ? rr(t) : (t instanceof IDBTransaction && tr(t), Xn(t, Qn()) ? new Proxy(t, we) : t);
}
function T(t) {
...
const sr = ["get", "getKey", "getAll", "getAllKeys", "count"], ar = ["put", "add", "delete", "clear"], ce = /* @__PURE__ */ new Map();
function qe(t, e) {
  if (!(t instanceof IDBDatabase && !(e in t) && typeof e == "string"))
    return;
  if (ce.get(e))
    return ce.get(e);
  const n = e.replace(/FromIndex$/, ""), r = e !== n, o = ar.includes(n);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(n in (r ? IDBIndex : IDBObjectStore).prototype) || !(o || sr.includes(n))
  )
    return;
...
const be = "@firebase/app", We = "0.10.0";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const k = new Yn("@firebase/app"), ur = "@firebase/app-compat", lr = "@firebase/analytics-compat", hr = "@firebase/analytics", dr = "@firebase/app-check-compat", fr = "@firebase/app-check", pr = "@firebase/auth", gr = "@firebase/auth-compat", mr = "@firebase/database", wr = "@firebase/database-compat", br = "@firebase/functions", yr = "@firebase/functions-compat", Er = "@firebase/installations", _r = "@firebase/installations-compat", vr = "@firebase/messaging", Cr = "@firebase/messaging-compat", Tr = "@firebase/performance", Ir = "@firebase/performance-compat", Sr = "@firebase/remote-config", Rr = "@firebase/remote-config-compat", Nr = "@firebase/storage", Dr = "@firebase/storage-compat", kr = "@firebase/firestore", Ar = "@firebase/firestore-compat", Or = "firebase";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const W = /* @__PURE__ */ new Map(), Lr = /* @__PURE__ */ new Map(), Ee = /* @__PURE__ */ new Map();
function ze(t, e) {
  try {
 ...
 * limitations under the License.
 */
const Br = "firebase-heartbeat-database", Ur = 1, j = "firebase-heartbeat-store";
let ue = null;
function ft() {
  return ue || (ue = Q(Br, Ur, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
          try {
            t.createObjectStore(j);
          } catch (n) {
            console.warn(n);
          }
      }
...
async function Vr(t) {
  try {
    const n = (await ft()).transaction(j), r = await n.objectStore(j).get(pt(t));
...
async function Ge(t, e) {
  try {
    const r = (await ft()).transaction(j, "readwrite");
    await r.objectStore(j).put(e, pt(t)), await r.done;
  } catch (n) {
    if (n instanceof B)
      k.warn(n.message);
    else {
 ...
 * limitations under the License.
 */
const Fr = 1024, jr = 30 * 24 * 60 * 60 * 1e3;
class Hr {
  constructor(e) {
  ...
  async triggerHeartbeat() {
    var e, n;
    const o = this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(), s = Je();
  ...
  async getHeartbeatsHeader() {
    ...
    if (this._heartbeatsCache === null && await this._heartbeatsCachePromise, ((e = this._heartbeatsCache) === null || e === void 0 ? void 0 : e.heartbeats) == null || this._heartbeatsCache.heartbeats.length === 0)
      return "";
    const n = Je(), { heartbeatsToSend: r, unsentEntries: o } = Kr(this._heartbeatsCache.heartbeats), s = st(JSON.stringify({ version: 2, heartbeats: r }));
 ...
 */
x(zr, Gr, "app");
const gt = "@firebase/installations", Ie = "0.6.6";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const mt = 1e4, wt = `w:${Ie}`, bt = "FIS_v2", Jr = "https://firebaseinstallations.googleapis.com/v1", Yr = 60 * 60 * 1e3, Xr = "installations", Qr = "Installations";
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
function Et({ projectId: t }) {
  return `${Jr}/projects/${t}/installations`;
}
function _t(t) {
  return {
    token: t.token,
    requestStatus: 2,
    expiresIn: to(t.expiresIn),
...
function eo(t, { refreshToken: e }) {
  const n = Ct(t);
  return n.append("Authorization", no(e)), n;
}
async function Tt(t) {
  const e = await t();
 ...
 * limitations under the License.
 */
async function ro({ appConfig: t, heartbeatServiceProvider: e }, { fid: n }) {
  const r = Et(t), o = Ct(t), s = e.getImmediate({
    optional: !0
  });
  if (s) {
...
function co(t, e) {
  const n = uo();
  n && n.postMessage({ key: t, fid: e }), lo();
}
let N = null;
function uo() {
 ...
 * limitations under the License.
 */
const ho = "firebase-installations-database", fo = 1, O = "firebase-installations-store";
let le = null;
function Se() {
  return le || (le = Q(ho, fo, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
...
async function z(t, e) {
  ...
  return await s.put(e, n), await o.done, (!a || a.fid !== e.fid) && Rt(t, e.fid), e;
}
async function Dt(t) {
...
async function ee(t, e) {
  ...
  return i === void 0 ? await s.delete(n) : await s.put(i, n), await o.done, i && (!a || a.fid !== i.fid) && Rt(t, i.fid), i;
}
/**
 * @license
 * Copyright 2019 Google LLC
...
function go(t, e) {
  if (e.registrationStatus === 0) {
    ...
    return e.registrationStatus === 1 ? {
      installationEntry: e,
      registrationPromise: wo(t)
    } : { installationEntry: e };
}
async function mo(t, e) {
  try {
    const n = await ro(t, e);
...
async function wo(t) {
  ...
  for (; e.registrationStatus === 1; )
    await It(100), e = await Xe(t.appConfig);
  if (e.registrationStatus === 0) {
 ...
 * limitations under the License.
 */
async function yo({ appConfig: t, heartbeatServiceProvider: e }, n) {
  const r = Eo(t, n), o = eo(t, n), s = e.getImmediate({
    optional: !0
  });
  if (s) {
    const h = await s.getHeartbeatsHeader();
...
async function _o(t, e) {
  let n = await Qe(t.appConfig);
  for (; n.authToken.requestStatus === 1; )
    await It(100), n = await Qe(t.appConfig);
  const r = n.authToken;
...
function Qe(t) {
  return ee(t, (e) => {
    ...
    const n = e.authToken;
    return So(n) ? Object.assign(Object.assign({}, e), { authToken: {
      requestStatus: 0
      /* RequestStatus.NOT_STARTED */
    } }) : e;
  });
...
async function vo(t, e) {
  try {
    const n = await yo(t, e), r = Object.assign(Object.assign({}, e), { authToken: n });
...
function Co(t) {
  return t.requestStatus === 2 && !To(t);
}
function To(t) {
  const e = Date.now();
  return e < t.creationTime || t.creationTime + t.expiresIn < e + Yr;
}
function Io(t) {
  const e = {
    requestStatus: 1,
 ...
 * limitations under the License.
 */
async function No(t, e = !1) {
  const n = t;
  return await Do(n), (await Ne(n, e)).token;
}
async function Do(t) {
 ...
 * limitations under the License.
 */
const Ot = "installations", Ao = "installations-internal", Oo = (t) => {
  const e = t.getProvider("app").getImmediate(), n = ko(e), r = Te(e, "heartbeat");
  return {
    app: e,
    appConfig: n,
  ...
  const e = t.getProvider("app").getImmediate(), n = Te(e, Ot).getImmediate();
  return {
    getId: () => Ro(n),
    getToken: (o) => No(n, o)
  };
 ...
 * limitations under the License.
 */
const $t = "BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4", Po = "https://fcmregistrations.googleapis.com/v1", Lt = "FCM_MSG", xo = "google.c.a.c_id", Mo = 3, Bo = 1;
var G;
(function(t) {
 ...
 * limitations under the License.
 */
const de = "fcm_token_details_db", Vo = 5, Ze = "fcm_token_object_Store";
async function Fo(t) {
  if ("databases" in indexedDB && !(await indexedDB.databases()).map((s) => s.name).includes(de))
    return null;
  let e = null;
  return (await Q(de, Vo, {
    upgrade: async (r, o, s, a) => {
      var i;
      if (o < 2 || !r.objectStoreNames.contains(Ze))
        return;
      const c = a.objectStore(Ze), h = await c.index("fcmSenderId").get(t);
      if (await c.clear(), !!h) {
        if (o === 2) {
          const l = h;
 ...
 * limitations under the License.
 */
const Ho = "firebase-messaging-database", Ko = 1, $ = "firebase-messaging-store";
let fe = null;
function De() {
  return fe || (fe = Q(Ho, Ko, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
          t.createObjectStore($);
...
async function ke(t) {
  ...
  if (r)
    return r;
  {
    const o = await Fo(t.appConfig.senderId);
    if (o)
...
}, y = new X("messaging", "Messaging", Wo);
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
async function Go(t, e) {
  const n = await Le(t), r = xt(e.subscriptionOptions), o = {
    method: "PATCH",
    headers: n,
    body: JSON.stringify(r)
  };
...
function $e({ projectId: t }) {
  return `${Po}/projects/${t}/registrations`;
}
...
function xt({ p256dh: t, auth: e, endpoint: n, vapidKey: r }) {
  ...
  return r !== $t && (o.web.applicationPubKey = r), o;
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 * limitations under the License.
 */
const Jo = 7 * 24 * 60 * 60 * 1e3;
async function Yo(t) {
  const e = await Qo(t.swRegistration, t.vapidKey), n = {
    vapidKey: t.vapidKey,
  ...
  if (r) {
    if (Zo(r.subscriptionOptions, n))
      return Date.now() >= r.createTime + Jo ? Xo(t, {
        token: r.token,
        createTime: Date.now(),
...
async function ve(t) {
  ...
  e && (await Pt(t.firebaseDependencies, e.token), await qo(t.firebaseDependencies));
 ...
 */
function os(t) {
  return typeof t == "object" && !!t && xo in t;
}
/**
 * @license
 * Copyright 2019 Google LLC
...
async function as(t, e) {
  const n = is(e, await t.firebaseDependencies.installations.getId());
  cs(t, n, e.productId);
}
function is(t, e) {
  var n, r;
  const o = {};
  return t.from && (o.project_number = t.from), t.fcmMessageId && (o.message_id = t.fcmMessageId), o.instance_id = e, t.notification ? o.message_type = G.DISPLAY_NOTIFICATION.toString() : o.message_type = G.DATA_MESSAGE.toString(), o.sdk_platform = Mo.toString(), o.package_name = self.origin.replace(/(^\w+:|^)\/\//, ""), t.collapse_key && (o.collapse_key = t.collapse_key), o.event = Bo.toString(), !((n = t.fcmOptions) === null || n === void 0) && n.analytics_label && (o.analytics_label = (r = t.fcmOptions) === null || r === void 0 ? void 0 : r.analytics_label), o;
}
function cs(t, e, n) {
  const r = {};
  r.event_time_ms = Math.floor(Date.now()).toString(), r.source_extension_json_proto3 = JSON.stringify(e), n && (r.compliance_data = us(n)), t.logEvents.push(r);
}
function us(t) {
  return {
    privacy_context: {
...
async function ls(t, e) {
  ...
  await ve(e), e.vapidKey = (r = (n = s == null ? void 0 : s.subscriptionOptions) === null || n === void 0 ? void 0 : n.vapidKey) !== null && r !== void 0 ? r : $t, await Yo(e);
}
async function hs(t, e) {
  const n = ps(t);
  if (!n)
    return;
  e.deliveryMetricsExportedToBigQueryEnabled && await as(e, n);
  const r = await Bt();
  if (ms(r))
    return ws(r, n);
  if (n.notification && await bs(fs(n)), !!e && e.onBackgroundMessageHandler) {
    const o = es(n);
...
async function ds(t) {
  ...
  if (s.host !== a.host)
    return;
  let i = await gs(s);
  if (i ? i = await i.focus() : (i = await self.clients.openWindow(o), await ss(3e3)), !!i)
...
function ys(t) {
  ...
  return o || (os(t.data) ? self.location.origin : null);
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 */
const vs = (t) => {
  const e = new _s(t.getProvider("app").getImmediate(), t.getProvider("installations-internal").getImmediate(), t.getProvider("analytics-internal"));
...
function Ss(t = Mr()) {
  ...
  }), Te(ut(t), "messaging-sw").getImmediate();
}
function Rs(t, e) {
  return t = ut(t), Is(t, e);
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */
Cs();
Rn([{"revision":null,"url":"assets/Harbor-9f98d2b1.js"},{"revision":null,"url":"assets/index-097dcd03.css"},{"revision":null,"url":"assets/Kafka-aa4340e8.js"},{"revision":null,"url":"assets/Kibana-2d66ac5e.js"},{"revision":null,"url":"assets/Kubernetes-4203471d.js"},{"revision":"1caeb234db9dac44301ed0b86b9c85df","url":"index.html"},{"revision":"615154b21d18141b388b64d08da82118","url":"manifest.webmanifest"}]);
In();
const Ns = {
  ...
  if (t.request.url.includes("&X-Amz-Expires")) {
    ...
    o || (o = new Request(t.request)), t.respondWith(
      fetch(o, { mode: "cors", credentials: "same-origin" }).then(async (s) => {
        const i = new URL(t.request.url).pathname.slice(1).split("/")[1], c = await Ut("s3", 1, ["s3", "aes"]), h = await $s(c, "aes", "key-" + decodeURIComponent(i), "readwrite", "");
          ...
          return s;
        {
          ...
          async function Pe() {
            const te = w.subarray(0, E), ne = await Os(te, h, decodeURIComponent(i), "AES-GCM");
            l = As(l, new Uint8Array(ne)), w.fill(0), E = 0;
          }
          let L = new Headers();
...
async function Os(t, e, n, r) {
  ...
  try {
    ...
    console.log(i);
    const c = await Ut("s3", 1, ["s3", "aes"]);
    return await Ls(c, "aes", "key-" + n, "readwrite"), new Uint8Array(0);
  }
  return a;
}
function Ut(t, e, n) {
